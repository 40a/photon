...
#    'logo': 'logo.png',
    ...
    'extra_nav_links': {
        'View on github': 'https://github.com/metacloud/photon',
    },
}
...
latex_documents = [
  (master_doc, 'Photon.tex', u'Photon Documentation',
...
man_pages = [
    (master_doc, 'photon', u'Photon Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Photon', u'Photon Documentation',
   author, 'AUTHORS.rst', 'A data driven tool to run workflows using Ansible.',
   'Miscellaneous'),
]
